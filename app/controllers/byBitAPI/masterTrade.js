...
const { copTrade } = require('../trade/helpers/copytrade')
 ...
 */
const masterTrade = async (req, res) => {
        ...
        if (user.trader_type == "master") {
            ...
            if (req.trade_at == "spot") {
                ...
                if (req.side == "Buy" || req.side == "buy") {
                    ...
                    if (data.retCode == 0) {
                        ...
                        if(req.istpsl === true){
                            ...
                            if (tradeData.retCode == 0) {
                                ...
                                await copTrade(user, req, tradee)
                                ...
                                console.log(tradeData, 'NEW ERRRORRU');
                                res.status(200).json({
                                    success: false,
                                    result: [],
                    ...
                    const data = await client.setMarginMode(mode)
                    if (data.retCode == 0) {
                        console.log(keydata,'SETTING COLLATREAL COIN');
            ...
            // }
                ...
                if (data.retCode == 0) {
                    ...
                    if(req.istpsl == true) {
                        ...
                        console.log(params,'futureorder');
                        const futureTrade = await client.submitOrder(params)
                        console.log(futureTrade, 'FUTURE ORDER RESPONSE');
                        if (futureTrade.retCode == 0) {
                            console.log(req.market, req.px, 'error place');
                            const futuretrade = {
                                user_id: user._id,
                                loan_user_id: user._id,
